...
@dataclass
class ADNeuRadarDataManagerConfig(ImageLidarRadarDataManagerConfig):
    """A basic data manager"""

    _target: Type = field(default_factory=lambda: ADNeuRadarDataManager)
...
class ADNeuRadarDataManager(ImageLidarRadarDataManager):
    ...
    config: ADNeuRadarDataManagerConfig
